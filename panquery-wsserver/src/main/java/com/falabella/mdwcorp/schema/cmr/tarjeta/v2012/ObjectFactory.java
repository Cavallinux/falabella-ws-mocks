...
public class ObjectFactory {
    ...
    private final static QName _Ano_QNAME = new QName("http://mdwcorp.falabella.com/schema/CMR/tarjeta/v2012.6", "ano");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mdwcorp.falabella.com/schema/CMR/tarjeta/v2012.6", name = "ano")
    public JAXBElement<String> createAno(String value) {
        return new JAXBElement<String>(_Ano_QNAME, String.class, null, value);
    }
