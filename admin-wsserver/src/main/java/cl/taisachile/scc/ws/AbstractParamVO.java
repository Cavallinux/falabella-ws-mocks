...
@XmlSeeAlso({
    AddDailyAmountParamVO.class,
    CreateSoftTokenParamVO.class,
    GetTransaParamVO.class,
    AssignGridParamVO.class,
    LockDeviceParamVO.class,
    UnlockDeviceParamVO.class,
    AssignTokenParamVO.class,
    GetUserParamVO.class,
    ActivateSoftTokenParamVO.class,
    GetCellsParamVO.class
})
