...
public class AdministrationWSImpl implements AdministrationWS {
    ...
    @Override
    public CreateSoftTokenResponseVO createSoftToken(
	    CreateSoftTokenParamVO params) {
    ...
    @Override
    public GetTransaResponseVO getGeneratedChallengeByClient(
	    GetTransaParamVO params) {
	// TODO Auto-generated method stub
	return null;
    }
    ...
    @Override
    public AddDailyAmountResponseVO addDailyAmount(
	    AddDailyAmountParamVO addDailyAmountParam) {
	// TODO Auto-generated method stub
	return null;
    }

    @Override
    public ActivateSoftTokenResponseVO activateSoftToken(
	    ActivateSoftTokenParamVO params) {
	// TODO Auto-generated method stub
	return null;
    }
