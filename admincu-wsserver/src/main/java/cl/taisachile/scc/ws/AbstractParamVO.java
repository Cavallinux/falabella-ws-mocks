...
@XmlSeeAlso({
    CreateUserParamVO.class,
    GetGenericOptionsParamVO.class,
    GetUserCUParamVO.class,
    ValidateChangePasswordSecurityCodeParamVO.class,
    ValidateSecurityCodeParamVO.class,
    ChangePasswordParamVO.class,
    GenerateChangePasswordSecurityCodeParamVO.class,
    ChangeLevelSecurityParamVO.class,
    DeleteUserCUParamVO.class,
    ExistActivationCodeCurrentParamVO.class,
    LockUserParamVO.class
})
